...
export default class ToggleMode extends Component {
  ...
  componentDidMount() {
    ...
    if (this.state.darkMode === true) {
      document.querySelector('.toggle-theme-circle').classList.add('active')
    }
  }
  ...
  handleModeChange() {
    ...
    if (!this.state.darkMode) {
      ...
      document.querySelector('.header-container').classList.remove('dark-mode-header');
    }
  ...
  render() {
    return <div className='toggle-theme' onClick={() => this.handleModeChange()}>
