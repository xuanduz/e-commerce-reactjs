  ...
  render() {
    ...
    return (
      <div className="product-view-container" key={this.state.oneProduct.slug}>
        {console.log('>>> check path: ', this.state.oneProduct.slug)}
        <div className="product-view row">
          <div className="product-view-image col-lg-7 col-12 row">
            <div className="product-view-image-thumb col-md-2">
              <div
                ...
                onClick={() => this.setState({
                  imageDetail: document.querySelector('.product-view-image-thumb1 img').src
                })}
              >
              ...
              <div
                ...
                onClick={() => this.setState({
                  imageDetail: document.querySelector('.product-view-image-thumb2 img').src
                })}
              >
            ...
            <div className="product-view-image-detail col-md-10 col-12">
              <img src={this.state.imageDetail === null ? this.state.oneProduct.image01 : this.state.imageDetail} alt="" />
            </div>
          ...
          <div className="product-view-detail col-lg-5 col-12">
            ...
            <div className="product-view-detail-price">
              <span>{this.state.oneProduct.price.replace(/\B(?=(\d{3})+(?!\d))/g, ".")}₫</span>
            </div>
            <hr />
            <div className="product-view-detail-color">
              ...
              <div className="product-view-detail-color-list">
                {this.state.oneProduct.colors.map((item, index) => (
                  <div
                    key={index}
                    className={item + ` ${this.state.color === item ? ' active' : ''}`}
                    onClick={() => this.setState({ color: item })}></div>
                ))}
              </div>
            </div>
            ...
            <div className="product-view-detail-amount">
              ...
              <div className="product-view-detail-amount-btn">
                <button className='amount-decrease' onClick={() => this.handleDecreaseBtn()}>-</button>
                <input
                  type="number"
                ...
                />
                <button className='amount-increase' onClick={() => this.handleIncreaseBtn()}>+</button>
              </div>
            </div>
        ...
        <div className="product-view-description">
          ...
          <div className='product-view-description-text' ref={this.description} >
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perferendis saepe ullam obcaecati ratione quidem eaque distinctio, provident a nemo ut possimus assumenda. Nulla porro exercitationem maiores quod? Laboriosam, voluptatibus quas. Earum fugit incidunt nisi, similique quia nulla molestias itaque, tenetur quibusdam doloribus accusamus possimus labore quasi tempora et assumenda, minus dignissimos. Fugit magni libero doloribus sed in molestiae exercitationem expedita quas id magnam quae unde illum omnis modi facere temporibus sint enim sunt, dolorum velit sit, pariatur ea illo. Facilis voluptas voluptates rerum qui ipsa ut similique veritatis, facere esse iure! Quisquam dolore soluta temporibus delectus aspernatur ducimus? Ut, quo? Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perferendis saepe ullam obcaecati ratione quidem eaque distinctio, provident a nemo ut possimus assumenda. Nulla porro exercitationem maiores quod? Laboriosam, voluptatibus quas. Earum fugit incidunt nisi, similique quia nulla molestias itaque, tenetur quibusdam doloribus accusamus possimus labore quasi tempora et assumenda, minus dignissimos. Fugit magni libero doloribus sed in molestiae exercitationem expedita quas id magnam quae unde illum omnis modi facere temporibus sint enim sunt, dolorum velit sit, pariatur ea illo. Facilis voluptas voluptates rerum qui ipsa ut similique veritatis, facere esse iure! Quisquam dolore soluta temporibus delectus aspernatur ducimus? Ut, quo?Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perferendis saepe ullam obcaecati ratione quidem eaque distinctio, provident a nemo ut possimus assumenda. Nulla porro exercitationem maiores quod? Laboriosam, voluptatibus quas. Earum fugit incidunt nisi, similique quia nulla molestias itaque, tenetur quibusdam doloribus accusamus possimus labore quasi tempora et assumenda, minus dignissimos. Fugit magni libero doloribus sed in molestiae exercitationem expedita quas id magnam quae unde illum omnis modi facere temporibus sint enim sunt, dolorum velit sit, pariatur ea illo. Facilis voluptas voluptates rerum qui ipsa ut similique veritatis, facere esse iure! Quisquam dolore soluta temporibus delectus aspernatur ducimus? Ut, quo? Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae illo enim esse soluta, ad expedita laboriosam quisquam necessitatibus vero autem rem voluptate, architecto tenetur sequi impedit eum numquam omnis corporis totam repellat temporibus aperiam inventore optio quidem. Voluptatum ullam unde laudantium harum aut reiciendis voluptate qui, reprehenderit velit deleniti neque? </p>
            <div className='linear-gradient'></div>
          </div>
          <div className="product-view-description-btn-readmore" ref={this.readMoreBtn}>
            <Button text='Đọc thêm' icon='readmore' onClick={() => this.handleReadMore()} />
          </div>
          <div className="product-view-description-btn-collapse hide" ref={this.collapseBtn}>
            <Button text='Thu gọn' icon='collapse' onClick={() => this.handleReadMore()} />
          </div>
        </div>
        <hr />
...
const mapDispatchToProps = (dispatch) => {
  return {
    addToCartRedux: (product) => dispatch({ type: 'ADD_TO_CART', payload: product })
  }
}
